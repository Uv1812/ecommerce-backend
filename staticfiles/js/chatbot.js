...
$(document).ready(function() {
    ...
    $('#connect-live-agent, #live-support-btn').click(function() {
        $('#chatbotModal').modal('hide');
        $('#liveSupportModal').modal('show');
        ...
        setTimeout(function() {
            ...
            $('#agent-status').html(`
                <span class="text-success">
                    <i class="fas fa-circle me-1" style="font-size: 0.7rem;"></i>Connected to Priya
                </span>
            `);
            
            // Show agent message
            $('#live-chat-messages').append(`
                <div class="chat-message system-message text-center mb-3">
                    <div class="message-content p-2 rounded d-inline-block">
                        <p class="mb-0">Agent Priya has joined the chat</p>
                    </div>
                </div>
                
                <div class="chat-message bot-message mb-3">
                    <div class="message-content p-3 rounded">
                        <p class="mb-0"><strong>Priya:</strong> Hello! I'm Priya from Customer Support. How may I assist you today?</p>
                    </div>
            ...
            // Enable chat input
            $('#live-chat-input').prop('disabled', false);
            $('#send-live-message').prop('disabled', false);
